<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Jenis Persuratan</a></li>
</ul>

<div class="page-header">
	<?php if($this->model_session->auth_display('role', 1)):?>
  <a href="<?php echo site_url('category/a')?>" class="btn btn-primary pull-right"><i class="icon-plus-sign icon-white"></i> Buat Baru </a>
  <?php endif?>
	<h2>Daftar Jenis Persuratan</h2>
</div>
...
$(document).ready(function() {
	...
	oTable = $('#xtable').dataTable( {
		...
		"bServerSide": true,
		"bAutoWidth": false,
		"sAjaxSource": "<?php echo site_url('category/json_data')?>"
	} );	
} );
</script>