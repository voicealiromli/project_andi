<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Buat Kolom</a></li>
</ul>
...
<?php echo form_open(site_url('column/i/'), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>
 ...
 <div class="control-group">
  ...
  <div class="control-group">
    <label class="control-label"><span class="important">Nama Baris</span></label>
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter Column Name" value="<?php echo $this->input->post('name')?>" />
