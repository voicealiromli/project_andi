<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Buat Rak</a></li>
</ul>
...
<?php echo form_open(site_url('rack/i/'), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>
 ...
 <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter Rack Name" value="<?php echo $this->input->post('name')?>" />
