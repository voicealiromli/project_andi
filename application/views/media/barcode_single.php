...
<div class="report-form-box">
	...
	<div id='barcodeView' class="barcode-container"></div>
	
	<div class="controls">
	<label class="controls-label">Nomor Debitur</label>:
	<span><?php echo $records->no?></span>
	</div>
	
	<div class="controls">
	<label class="controls-label">Nama Debitur</label>:
	<span><?php echo $records->title ?></span>
	</div>

	<p class="corporate-title"><img src="<?php echo base_url('assets/img/logo.jpg')?>" width="100"><?php echo $sys['DEPARTEMEN']?></p>
...
$("#barcodeView").barcode("<?php echo $records->no?>", "code128", {barWidth:2, barHeight:60, fontSize:16});
</script>
