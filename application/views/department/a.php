<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Buat Departemen</a></li>
</ul>

<div class="page-header">
	<h2>Buat Departemen</h2>
</div>

<?php echo form_open(site_url('department/i/'), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>

  <div class="control-group">
    <label class="control-label"><span class="important">Kode</span></label>
    <div class="controls">
    <input type="text" class="input-xlarge" id="code" name="code" placeholder="Enter Department Code" value="<?php echo $this->input->post('code')?>" />
    ...
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter Department Name" value="<?php echo $this->input->post('name')?>" />
