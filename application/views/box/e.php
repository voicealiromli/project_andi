<ul class="breadcrumb">
  ...
  <li><a href="<?php echo site_url('column')?>" class="btn btn-mini">Daftar Box</a></li>
  <li><a href="javascript:;" class="btn btn-mini disabled">Update Box</a></li>
</ul>
...
<?php echo form_open(site_url('box/u/'.$records->boxID), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>
<input type="hidden" name="id" value="<?php echo $records->boxID?>">
 <div class="control-group">
  ...
  <div class="control-group">
   ...
   <option value="<?php echo $cl->colID?>" class="<?php echo $cl->row_id?>"<?php  if($cl->colID == $records->col_id){echo 'selected="selected"';}?>><?php echo $cl->col_name?></option>
   <?php endforeach;?>
   </select>
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter Name Box" value="<?php echo $records->box_name?>" />
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <textarea id="desc" name="desc"><?php echo $records->box_desc?></textarea>
