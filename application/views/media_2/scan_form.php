...
<!--                <label class="radio inline"><input name="ImageType" id="imgTypejpeg2" type="radio" value="jpg" onclick="rd_onclick();">JPEG</label>
                ...
                <label class="radio inline"><input name="ImageType" id="imgTypepdf2" type="radio" value="pdf" onclick="rdPDF_onclick();">PDF</label>
            </div>
            <div class="controls">
                <!--<label class="checkbox inline"><input id="MultiPageTIFF" type="checkbox">Multi-Page TIFF</label>-->
                <label class="checkbox inline"><input id="MultiPagePDF" type="checkbox">Multi-Page PDF</label>
            </div>
        </div>
...
function btnUpload_onclick() {//For Dynamic Mac TWAIN, no progress bar will show
  ...
  var redirectURLifOK = "<?php echo site_url( 'media/s_v/'.$this->uri->segment(3).'?url='.redirect_check() )?>";
    ...
    var uploadfilename = txt_fileDesc.value + "-x-" + txt_fileName.value + "." + document.getElementsByName("ImageType").item(i).value;
