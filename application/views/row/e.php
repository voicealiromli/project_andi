<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Update Baris</a></li>
</ul>
...
<?php echo form_open(site_url('row/u/'.$records->rowID), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>
<input type="hidden" name="id" value="<?php echo $records->rowID?>">
 <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter Name Row" value="<?php echo $records->row_name?>" />
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <textarea id="desc" name="desc"><?php echo $records->row_desc?></textarea>
