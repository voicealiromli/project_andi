<ul class="breadcrumb">
  ...
  <li><a href="javascript:;" class="btn btn-mini disabled">Update Ruangan</a></li>
</ul>
...
<?php echo form_open(site_url('room/u/'.$records->roomID), array('class'=>"form-horizontal alt1", 'id'=>'form1'))?>
<input type="hidden" name="id" value="<?php echo $records->roomID?>">
 <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <input type="text" class="input-xlarge" id="name" name="name" placeholder="Enter the name of the space" value="<?php echo $records->room_name?>" />
  ...
  <div class="control-group">
    ...
    <div class="controls">
    <textarea id="desc" name="desc"><?php echo $records->room_desc?></textarea>
